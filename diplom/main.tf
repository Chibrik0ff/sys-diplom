...
resource "yandex_compute_instance" "vm-1" {
  ...
  metadata = {
    ssh-keys = "ubuntu:${file("/home/chibrik0ff/.ssh/id_rsa.pub")}"
  }
}
...
resource "yandex_compute_instance" "zabbix" {
  ...
  metadata = {
    ssh-keys = "ubuntu:${file("/home/chibrik0ff/.ssh/zabbix.pub")}"
  }
}
...
resource "yandex_compute_instance" "elas" {
  ...
  network_interface {
    ...
    metadata = {
    ssh-keys = "ubuntu:${file("/home/chibrik0ff/.ssh/elk.pub")}"
  }
}  
...
resource "yandex_compute_instance" "kib" {
  ...
  metadata = {
    ssh-keys = "ubuntu:${file("/home/chibrik0ff/.ssh/kib.pub")}"
  }
}
...
resource "yandex_compute_instance" "bast" {
  ...
  metadata = {
    ssh-keys = "ubuntu:${file("/home/chibrik0ff/.ssh/bastion.pub")}"
  }
